<template>
    <v-container>
        ...
        <v-card>
            <v-card-title class="headline">Here you will be able to play some music</v-card-title>
            <v-card-text>
                ...
                <p>Thank you for developing with Vuetify and <I></I> look forward to bringing more exciting features in the future.</p>
